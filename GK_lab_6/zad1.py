...
def compile_shaders():
    vertex_shader_source = """
        ...
        out vec4 vertex_color;  // Nowa zmienna wyjściowa

        void main(void) {
            gl_Position = P_matrix * V_matrix * M_matrix * position;
            vertex_color = vec4(0.2, 0.9, 0.1, 1.0);  // Ustawienie koloru wierzchołków
        }
    """
    ...
    fragment_shader_source = """
        ...
        in vec4 vertex_color;  // Nowa zmienna wejściowa

        out vec4 color;

        void main(void) {
            color = vertex_color;  // Przekazanie koloru z shadera wierzchołków
        }
    """
